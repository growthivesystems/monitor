...
const TRANSLATIONS = {
  en: {
    ...
    is_used:'is used.',
    no_sales_period:'No sales recorded for this period.',
    no_data_period:'No data for this period.',
    no_items_catalogue:'No items in catalogue yet.',
    add_inventory_items:'Add Inventory Items →',
    add_expense_btn:'Add Expense',
    monthly_summary_title:'Monthly Summary',
    pos_revenue_vs_expenses:'POS Revenue vs Expenses',
    profit_loss_trend:'Profit / Loss Trend',
    based_on_confirmed:'Based on confirmed daily sales records',
    profit_loss_confirmed:'Profit/Loss (Confirmed)',
    revenue_purchase:'Revenue = purchase_transactions',
    expenses_table:'Expenses = expenses table',
    download_report:'Download your report as a printable summary.',
    quick_links:'Quick Links',
    powered_by:'Powered by',
    building_tools:'Building tools that empower businesses everywhere.',
    your_all_in_one:'Your all-in-one digital business record management system. Track sales, expenses, inventory and grow smarter.',
    terms_conditions:'Terms & Conditions',
    contact_us:'Contact Us',
    more_from:'More from GrowthIve Systems',
    explore_suite:'GrowthIve Monitor is just one of our powerful business tools. Explore our full suite of services designed to help businesses grow, scale, and thrive in the digital age.',
    visit_growthive:'Visit GrowthIve Systems →',
    share_cart:'Share Cart',
    clear_cart_confirm:'Are you sure you want to clear the cart?',
    no_stock_added:'No items added to stock yet.',
    search_items_services:'Search items or services…',
    all_filter:'All',
    tracked:'Tracked',
    untracked:'Untracked',
    out_of_stock_tracked:'Out of stock (tracked)',
    items_this_month:'entries this month',
    this_month_label:'This month',
    unpaid_balances_label:'Unpaid balances',
    revenue_expenses_label:'Revenue − expenses this month',
    daily_sales_pos_label:'Daily sales + POS this month',
    one_transaction:'1 transaction today',
    transactions_today:'transactions today',
    share_kwandon:'Share Kwandon',
  },
  ...
  yo: {
    ...
    no_sales_period:'Ko si tita tí a gbasilẹ fún àkókò yìí.',
    no_data_period:'Ko si data fún àkókò yìí.',
    no_items_catalogue:'Ko si ohun elo nínú katalogi.',
    add_inventory_items:'Fi Àwọn Ohun Elo Ọja Kun →',
    add_expense_btn:'Fikun Inawo',
    monthly_summary_title:'Akopọ Oṣù',
    pos_revenue_vs_expenses:'Owo POS vs Inawo',
    profit_loss_trend:'Ìtọjú Ere / Àdánù',
    based_on_confirmed:'Lórí àwọn igbasilẹ tita ojoojumọ tí a jẹrisi',
    profit_loss_confirmed:'Ere/Àdánù (Tí a Jẹrisi)',
    download_report:'Gbe ijabọ rẹ sile gẹgẹbi akopọ tí o lè tẹ.',
    quick_links:'Àwọn Ìjápọ̀ Ìyára',
    powered_by:'Agbára rẹ lati',
    building_tools:'Ṣíṣe àwọn irinṣẹ tí ń fikun agbára àwọn iṣowo nibi gbogbo.',
    your_all_in_one:'Ètò àkọọlẹ iṣowo àpapọ̀. Tọpa tita, inawo, ọja àti dàgbà ní ọgbọ́n.',
    terms_conditions:'Àwọn Ìlànà àti Ipò',
    contact_us:'Kàn Sí Wa',
    more_from:'Díẹ̀ síi lati GrowthIve Systems',
    visit_growthive:'Ṣabẹwò GrowthIve Systems →',
    search_items_services:'Wa ohun elo tabi awọn iṣẹ…',
    all_filter:'Gbogbo',
    this_month_label:'Oṣù yìí',
    unpaid_balances_label:'Awọn iye tí a ko sanwo',
    one_transaction:'Iṣowo 1 lónìí',
    transactions_today:'àwọn iṣowo lónìí',
  },
  ...
  ig: {
    ...
    no_sales_period:'Achọtaghị ahịa maka oge a.',
    no_data_period:'Enweghị data maka oge a.',
    no_items_catalogue:'Enweghị ihe n'ime ndepụta ugbu a.',
    add_inventory_items:'Tinye Ngwongwo →',
    add_expense_btn:'Tinye Ego A Na-eji',
    monthly_summary_title:'Nchoputa Ọnwa',
    pos_revenue_vs_expenses:'Ego POS vs Ego A Na-eji',
    profit_loss_trend:'Ọganihu Uru / Ọnwụ',
    based_on_confirmed:'Dabere na ndekọ ahịa kwa ụbọchị e kwenyere',
    profit_loss_confirmed:'Uru/Ọnwụ (E Kwenyere)',
    download_report:'Budata akụkọ gị dị ka nchoputa enwere ike ibipụta.',
    quick_links:'Njikọ Ngwa Ngwa',
    powered_by:'Nke na-enye ike',
    building_tools:'Iji arụ ngwa na-enye azụmaahịa ike n'ebe niile.',
    your_all_in_one:'Usoro njikwa ndekọ azụmaahịa nke otu. Soro ahịa, ego a na-eji, ngwongwo ma too uto.',
    terms_conditions:'Usoro na Ọnọdụ',
    contact_us:'Kpọtụrụ Anyị',
    more_from:'Ọzọ site na GrowthIve Systems',
    visit_growthive:'Bịa GrowthIve Systems →',
    search_items_services:'Chọọ ihe ma ọ bụ ọrụ…',
    all_filter:'Niile',
    this_month_label:'Ọnwa a',
    unpaid_balances_label:'Ego a akwụghị',
    one_transaction:'Azụmaahịa 1 taa',
    transactions_today:'azụmaahịa taa',
  }
};
