  ...
  el.innerHTML = `
    <footer>
      <div class="footer-services">
        ...
        <a href="YOUR_MAIN_WEBSITE_URL_HERE" target="_blank" class="btn btn-gold btn-sm">Visit GrowthIve Systems →</a>
      </div>
      <div class="footer-grid">
        ...
        <div>
          ...
          <a href="YOUR_MAIN_WEBSITE_URL_HERE" target="_blank" style="color:var(--gold);font-size:0.82rem;">growthivesystems.com →</a>
        </div>
      </div>
      <div class="footer-bottom">
        <span>© ${new Date().getFullYear()} GrowthIve Monitor. Powered by <a href="YOUR_MAIN_WEBSITE_URL_HERE" target="_blank">GrowthIve Systems</a>.</span>
